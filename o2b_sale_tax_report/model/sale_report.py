...
class AccountInvoiceReportTax(models.Model):
    _name = "account.invoice.totaltax"
    _description = "Invoices Tax Total"
    _auto = False
    _rec_name = 'date'
    ...
    paid_total_amount = fields.Float(string='Total Amount Received', readonly=True)
    paid_total_tax_amount = fields.Float(string='Tax Received', readonly=True)
    ...
    _depends = {
        'account.invoice': [
            ...
            'residual', 'state', 'type', 'user_id','paid_total_amount','paid_total_tax_amount',
        ],
    ...
    def _select(self):
        select_str = """
            SELECT sub.id, sub.date, sub.product_id, sub.partner_id, sub.country_id, sub.account_analytic_id,
                ...
                sub.product_qty, sub.price_total as price_total, sub.price_average as price_average, sub.paid_total_amount as paid_total_amount, sub.paid_total_tax_amount as paid_total_tax_amount,
    ...
    def _sub_select(self):
        select_str = """
                SELECT ail.id AS id,
                    ...
                    ai.paid_total_amount AS paid_total_amount,
                    ai.paid_total_tax_amount AS paid_total_tax_amount,
    ...
    def _group_by(self):
        group_by_str = """
                GROUP BY ail.id, ail.product_id, ail.account_analytic_id, ai.date_invoice, ai.id,
                    ai.partner_id, ai.paid_total_amount, ai.paid_total_tax_amount, ai.payment_term_id, u2.name, u2.id, ai.currency_id, ai.journal_id,
